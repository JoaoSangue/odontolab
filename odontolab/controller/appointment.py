...
class AppointmentRouter(RouterDecorator):
    def defineRoutes(self):
        @self._router._app.get('/appointments/next/')
        ...
        @self._router._app.post('/appointments/next/')
        ...
        @self._router._app.get('/patients/<int:id>/appointments/new/')
        ...
        @self._router._app.post('/patients/<int:id>/appointments/new/')
        ...
        @self._router._app.get('/patients/<int:id>/appointments/')
        ...
        @self._router._app.post('/patients/<int:patient_id>/appointments/<int:appointment_id>/')
